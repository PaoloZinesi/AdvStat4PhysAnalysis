...
```{r}
cat("Corp 1: mean=", signif(mean_corp1_u, 3), ", median=", signif(median_corp1_u, 3), ", variance=", signif(var_corp1_u, 3), "\n",
    "\t95% credibility interval=[", signif(CI_corp1_u[1],3), ",", signif(CI_corp1_u[2],3), "]\n", sep="")
cat("Corp 2: mean=", signif(mean_corp2_u, 3), ", median=", signif(median_corp2_u, 3), ", variance=", signif(var_corp2_u, 3), "\n",
...
```{r}
cat("Corp 1: mean=", signif(mean_corp1_J, 3), ", median=", signif(median_corp1_J, 3), ", variance=", signif(var_corp1_J, 3), "\n",
    "\t95% credibility interval=[", signif(CI_corp1_J[1],3), ",", signif(CI_corp1_J[2],3), "]\n", sep="")
cat("Corp 2: mean=", signif(mean_corp2_J, 3), ", median=", signif(median_corp2_J, 3), ", variance=", signif(var_corp2_J, 3), "\n",
...
cat("With Beta(1,10) prior:\n\tBayesian estimate for p = ", signif(p_3e_beta_B,3), ", mean=", signif(mean_3e_beta, 3), ", variance=", signif(var_3e_beta, 3), "\n",
    "\t95% credibility interval=[", signif(CI_3e_beta_B[1],3), ",", signif(CI_3e_beta_B[2],3), "]\n", sep="")
cat("With previous posterior as a new prior:\n\tBayesian estimate for p = ", signif(p_3e_new_B,3), ", mean=", signif(mean_3e_new, 3), ", variance=", signif(var_3e_new, 3), "\n",
...
# model computations
jm4 <- jags.model("model4.bug", data4, quiet=TRUE)
...
cat("Mean computed by JAGS = ", signif(mean_4_post,4), "\n", sep="")
cat("Mean computed (analytically) in point 1 = ", signif(mean_beta1_post,4), "\n", sep="")
cat("-----------\n")
cat("Variance computed by JAGS = ", signif(sd_4_post**2,4), "\n", sep="")
cat("Variance computed (analytically) in point 1 = ", signif(var_beta1_post,4), "\n", sep="")
cat("-----------\n")
cat("95% credibility interval computed by JAGS = [", signif(CI_1_post[1],3), ",", signif(CI_1_post[2],3), "]\n", sep="")
cat("95% credibility interval computed in point 1 = [", signif(CI_4_post[1],3), ",", signif(CI_4_post[2],3), "]\n", sep="")
```
...
```{r}
cat("Statistics for corp 1:\n")
print(summary(chain5_corp1_u)$statistics)
cat("\nQuantiles for corp 1:\n")
print(summary(chain5_corp1_u)$quantiles)
cat("\n\n")
cat("Statistics for corp 2:\n")
print(summary(chain5_corp2_u)$statistics)
cat("\nQuantiles for corp 2:\n")
print(summary(chain5_corp2_u)$quantiles)
```
...
```{r}
cat("Statistics for corp 1:\n")
print(summary(chain5_corp1_J)$statistics)
cat("\nQuantiles for corp 1:\n")
print(summary(chain5_corp1_J)$quantiles)
cat("\n\n")
cat("Statistics for corp 2:\n")
print(summary(chain5_corp2_J)$statistics)
cat("\nQuantiles for corp 2:\n")
print(summary(chain5_corp2_J)$quantiles)
```
...
# model computations
jm6 <- jags.model("model6.bug", data6, quiet=TRUE)
update(jm6, 1000, progress.bar="none")
